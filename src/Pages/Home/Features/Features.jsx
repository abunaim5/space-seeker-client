...
const Features = () => {
    const features = [
        {
            icon: <TimeIcon textColor='#00CC66' fontSize='4xl' />,
        ...
        {
            icon: <Icon as={FaRegCalendarCheck} textColor='#00CC66' fontSize='4xl' />,
        ...
        {
            icon: <Icon as={FaDollarSign} textColor='#00CC66' fontSize='4xl' />,
